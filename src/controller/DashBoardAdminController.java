...
public class DashBoardAdminController {
    ...
    public void movebleOnAction(ActionEvent actionEvent) throws IOException, JRException, SQLException, ClassNotFoundException {
        JasperDesign design = JRXmlLoader.load(this.getClass().getResourceAsStream("/View/report/pieChart.jrxml"));
